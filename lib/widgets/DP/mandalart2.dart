  ...
  Widget build(BuildContext context){
    return Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    ? Color(int.parse(widget.secondGoals[widget.hintNum]['color'].replaceAll('Color(', '').replaceAll(')',''))) 
                    : Colors.transparent,
                  ),
                  child: Center(
                    child: Text(
                      widget.secondGoals.isNotEmpty && widget.secondGoals[widget.hintNum]['secondGoal'] != "" ? widget.secondGoals[widget.hintNum]['secondGoal'] : "",
                      textAlign: TextAlign.center,
                    ),
                  )
                );
      ...
      GestureDetector(
        onTap: (){
          ...
          ? context.read<SelectAPModel>().selectAP(
              widget.secondGoals[widget.hintNum2]['thirdGoals'][widget.hintNum3]['thirdGoal'],
              widget.secondGoals[widget.hintNum2]['thirdGoals'][widget.hintNum3]['id'])
