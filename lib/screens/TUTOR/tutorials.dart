...
class _TutorialsState extends State<Tutorials> {
  final List<String> _list = [
    'assets/img/tutor/tutor_1_re.png',
    'assets/img/tutor/tutor_2_re.png',
    'assets/img/tutor/tutor_3_re.png',
    'assets/img/tutor/tutor_4_re.png',
    'assets/img/tutor/tutor_5_re.png',
    'assets/img/tutor/tutor_6_re.png',
    'assets/img/tutor/tutor_7_re.png',
  ]; //이미지 리스트
